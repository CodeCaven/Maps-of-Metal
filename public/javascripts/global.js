...
var multi_views = {"Canada":[{"loc":[-123.116226, 49.246292], "radius": 32, "tags":["Vancouver", "Victoria"]},
                   ...
                   "Indonesia":[{"loc":[ 107.21709400898749,  -6.536913845087203], "radius": 32, "tags":["Jakata", "Bandung"]}],
...
var neighbours = {"Northeast":["Ohio", "Kentucky", "Virginia", "West Virginia", "Michigan"],
                  ...
                  "Africa": ["Suriname", "Guyana", "Columbia", "Venezuela", "Cape Verde", "Anguilla", "Antigua and Barbuda", "Barbados", "Dominica",  "Grenada", "Jamaica", "Saint Kitts and Nevis", "Saint Lucia", "United States Virgin Islands", "British Virgin Islands", "Cayman Islands", "Saint Vincent and the Grenadines", "Trinidad and Tobago", "Montserrat", "Antilles", "Turks and Caicos", "Curacao", "Bolivia", "Uruguay", "Paraguay", "Argentina", "Spain","Brazil", "Portugal", "France", "India", "Afghanistan", "Kazakhstan", "Kyrgyzstan", "Pakistan", "Tajikistan", "Turkmenistan", "Uzbekistan" ,"Russia", "Moldova", "Ukraine", "Germany", "Italy",  "Greece", "Bosnia and Herzegovina", "Republic of Serbia", 'Albania', 'Montenegro', 'Austria','Slovenia','Croatia','Kosovo','Bulgaria','Romania','Macedonia','Hungary','Switzerland','Malta',
...
let anchors = {"Los Angeles": "end", "San Francisco": "end", "Long Beach": "start", "Oakland": "start","Denver":"top", "St. Louis":"start","Santa Fe":"start",
 "Bergen": "end", "Umeå": "start", "Seattle":"start","New York City": "end",  "Boston": "top", "Portland": "end","San Antonio":"end","Eugene":"end",
...
'Louisville': 'top','Greensboro': 'end','Lexington': 'start', "Sarasota": "end",  'Katowice':'end',"Tarnów":'start',"Lublin":'start', 'Dalarna': 'top',"Mumbai":"end","Pune":"start",
 ...
 'Asheville': 'top','Bowling Green': 'end','Gainesville': 'start','Birmingham': 'end','Sanford': 'start','Bridgeport': 'top',"Phoenix":"start","Tucson":"start",
 ...
 'Glasgow': 'end','Brighton': 'start','Reading': 'top','Bogota':"start",'Brasília':"top",'Caracas':'start','Porto Alegre':"end",'Poitiers':'top','Yutz':'top','Long Island':'start',
...
"Vancouver":"top","Montreal":"start","Ottawa":"end", 'Quebec City':'start', 'Edmonton':'top','Pittsburgh':'end',"Leeds":'start','Lappeenranta':'start','Lahti':'top','Tampere':'end',"Sapporo":'end',"Tel Aviv":"end","Mauritius":'top',
...
'Jakata':'top','Semarang':'top','Bukittinggi':'end',"Medan":"end",'Kuala Lumpur':'end',"Samarinda":'top','Kuala Terengganu':'top','Johor Bahru':'end','Kota Kinabalu':'end','Sandakan':'start','Ipoh':'top','Pahang':'start',"Alor Setar":'top',
...
'Rawalpindi':'end','Lahore':'end',"Chittagong":'start','Karachi':'end','Guwahati':'start','Kathmandu':'top','Kolkata':'end', 'Dhaka':'top','Maldives':'end','Colombo':'start'};

 let radii = {'Washington, D.C.': 18,'Providence': 14,'Philadelphia': 20, 'Hartford':22, 'Buffalo':22,'New Jersey': 25, 'Pittsburgh': 24,'New York City': 29,'Boston': 22,'Bridgeport': 14,'New Brunswick': 20,'Minneapolis': 25,"Atlanta": 23,"Melbourne":28,"Granada‎":22,"Valencia":22,
 ...
 'Milan': 28,'Rome': 30,'Turin': 27,'Verona': 25,'Udine': 20,'Naples': 25,'Florence': 25,'Catania': 25,'Palermo': 25,'Managua':22,"Kraków":26,'Łódź':24,"Tarnów":24,"Lyon":26,"Nashville":22,"Alexandria":22,"Phoenix":25,"Casablanca":22,
...
"Stavanger": 27, "Skien":26, "Sogndal":22, 'Trondheim':24, 'Hamar':22, 'Etne':22, 'Gothenburg':30, 'Dalarna': 18, 'Borlänge':18, 'Umeå': 26, 'Helsinki':30,'Oulu':26,'Hämeenlinna':20, 'Tampere': 22, 'Kouvola':18, 'Lahti':19,"Tunis":21,"Tripoli":17,
'San Antonio':24, 'New Orleans':22,'Albuquerque':25, 'Houston':23, 'Tulsa':22, 'Austin':19, 'Sandviken':26, 'Helsingborg':28,'Linköping':24,'Ludvika':22,'Caracas':22,'Topeka':16, 'Mankato':18, "Canberra":16, "Brisbane":22,"Cape Town":24,"Port Elizabeth":18,
...
'Norwich':20,'Ipswich':18, "Semarang":24,'Bukittinggi':23, "Malang":24,'Kuala Lumpur':27,'Ipoh':24,'Kota Kinabalu':24,"Sandakan":24,"Alor Setar":22, 'Bangalore':23,'New Delhi':25,'Guwahati':22,'Karachi':22}
