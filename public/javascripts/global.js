...
var multi_views = {"Canada":[{"loc":[-123.116226, 49.246292], "radius": 32, "tags":["Vancouver", "Victoria"]},
                   ...
                   "THRASH Northeast":[{"loc":[ -76.88485526922724,  39.154907715375444], "radius": 30, "tags":["Baltimore", 'Washington, D.C.']},
                                {"loc":[ -73.16056222266681,  41.05539314235577], "radius": 23, "tags":["Long Island", 'Bridgeport']},
                   ...
                   "DEATH Northeast":[{"loc":[ -76.88485526922724,  39.154907715375444], "radius": 30, "tags":["Baltimore", 'Washington, D.C.']},
                                {"loc":[ -71.2648711576945,  42.09195435040254], "radius": 28, "tags":["Boston", 'Providence']}],
                   "Northeast":[{"loc":[ -71.2648711576945,  42.09195435040254], "radius": 28, "tags":["Boston", 'Providence']}],
                   "DEATH United Kingdom":[{"loc":[ -2.9262719286836014,  51.47573264168695], "radius": 26, "tags":["Cardiff", 'Bristol']}],
                   "Italy":[{"loc":[ 10.773033184863754,  43.71804196778421], "radius": 25, "tags":["Florence", 'Pisa']}],// 43.71804196778421, 10.773033184863754
                   ...
                   "THRASH Germany":[{"loc":[ 7.035311385098635,  51.34081411741906], "radius": 32, "tags":["Düsseldorf", "Essen", 'Dortmund']}],
                   ...
                   "Chile":[{"loc":[ -71.11237226026695,  -33.259161001816715], "radius": 32, "tags":['Valparaíso', "Santiago"]},
                   ...
                   "Southeast Asia":[{"loc":[ 107.21709400898749,  -6.536913845087203], "radius": 28, "tags":["Jakata", "Bandung"]},
                                    {"loc":[ 105.73407405349023,  11.26707236413902], "radius": 24, "tags":["Ho Chi Minh City", "Phnom Penh"]},
                   ...
                   "South Asia":[{"loc":[ 73.36686601754629,  18.975856865983314], "radius": 28, "tags":["Mumbai", "Pune"]},
                   ...
                   "Middle East":[{"loc":[ 36.278336,  33.510414], "radius": 16, "tags":["Damascus", "Beirut"]}, //-27.639415661554715, 28.965562315303508
...
let anchors = {"Los Angeles": "end", "San Francisco": "end", "Long Beach": "start", "Oakland": "start","Denver":"top", "St. Louis":"start","Santa Fe":"start",
 "Bergen": "end", "Umeå": "start", "Seattle":"start","New York City": "end",  "Boston": "top", "Portland": "start","Amarillo":"top","Eugene":"start",
  "Derby":'start', "Sapcote":'start', "Hartford":"end", "Trenton": "end",  "Dallas" : "start", "Richmond" : "start", "Cedar Rapids":"start", "Omaha":"end","DeKalb":"end",
  "Tampa" : "end", "Austin": "top", "Albuquerque":"start", "Corpus Christi":"start","Medellín":"end","Canberra":"end","Phnom Penh":'top',
"Berlin":"start", "Essen":"top", "Dortmund":"end", "Waco":"end", "Little Rock":"start","Fort Worth":"end","Santa Cruz":"end","Taranto":"start",
...
"London":"start","Newcastle upon Tyne":"start","Liverpool":"end","Belfast":"end", "Kansas City":"top","Salamanca":"end",
'Bonn': 'end','Stuttgart': 'end','Leipzig': 'start', 'Münster': 'top',"Buffalo":"end","Rochester":"start","Poznań":'end',"Wollongong":"start","Bolzano":"start","Lecce":'start',
"Regensburg":"start", "Schweinfurt":"start", "Siegen":"start", 'Kiel': 'start','Jena': 'end','Bremen': 'end',"Adelaide":'top', "Perth":'top',
'Osnabrück': 'end','Cologne': 'start','Schneeberg': 'start','Baton Rouge': 'end','Tulsa': 'top','Wichita Falls': 'end','Ludvika':'end',"New South Wales":"top",
'Louisville': 'top','Greensboro': 'end','Lexington': 'start', "Sarasota": "end",  'Katowice':'end',"Tarnów":'start',"Lublin":'start', 'Dalarna': 'top',"Mumbai":"end","Pune":"start",
 ...
 'Asheville': 'top','Bowling Green': 'end','Gainesville': 'start','Sanford': 'start','Bridgeport': 'top',"Phoenix":"start","Tucson":"start","El Paso":"start",
 ...
 'Skellefteå':'end','Halmstad':'end','Gävle':'start','Karlskrona':'start','Philadelphia':'end','Ipswich':'start',"Słupsk":'end','Hämeenlinna':'end','Brest':'top', 'Lyon':'end','Grenoble':'start','Arlington':'top',
 'Tegucigalpa':'top','Guatemala City':'top','Managua':'end','Panama City':'start','San Pedro Sula':'top','Grand Rapids':'top',"Częstochowa":'start','Jyväskylä':'end','Kuopio':'start',"Melbourne":"start",'Erfurt':'start',
...
"Vancouver":"top","Montreal":"start","Ottawa":"end", 'Quebec City':'top', 'Edmonton':'top','Pittsburgh':'start',"Leeds":'start','Lappeenranta':'start','Lahti':'top','Tampere':'end',"Sapporo":'end',"Tel Aviv":"end","Mauritius":'top',
'Bilbao':'end', 'Pamplona':'start','Vigo':'end','Norwich':'start', 'A Coruña':'end','Palma':'start','Cardiff':'end','Vitoria-Gasteiz':'end',"Zarautz":'start',"Algeciras":'end', 'Nagoya':'top', 'Tokyo':'start',"Yamaguchi":'top','Istanbul':'top','Augsburg':'end',
'Guadalajara':'end','Irapuato':'top','Cheltenham':'end','Tampico':'start',"San Diego":'end', 'Monterrey':'start','Mexico City':'start',"Cancún":'start','Damascus':'top','Tbilisi':'top','Baku':'start', 'Dubai':'start','Damascus':'start','Beirut':'end','Bahrain':'start','Dammam':'end','Kuwait City':'start',
'Jakata':'top','Semarang':'top','Bukittinggi':'end',"Medan":"end",'Kuala Lumpur':'top',"Samarinda":'top','Kuala Terengganu':'top','Johor Bahru':'end','Sandakan':'start','Ipoh':'top','Pahang':'start',"Alor Setar":'top',"Nijverdal":'start',"Zwolle":'end',
"Tawau":'start','Sibu':'end','Harare':'top',"Johannesburg":'top',"Durban":'start',"Bloemfontein":'end','Cape Town':'end','Port Elizabeth':'start', 'Tunis':'start', 'Tripoli':'start', 'Algiers':'top','Casablanca':'end', 'Cairo':'start','Nairobi':'start',
'Rawalpindi':'end','Lahore':'end',"Chittagong":'start','Karachi':'end','Guwahati':'start','Kathmandu':'top','Kolkata':'end', 'Dhaka':'top','Maldives':'end','Colombo':'start', 'The Hague':'top', 'Amsterdam':'top', 'Sneek':'top','Groningen':'start',"Winterswijk":'start',
"Enschede":'start', 'Tilburg':'end',"Viseu":'start', 'North Brabant':'start','Heerlen':'top', 'Funchal':'end', 'Lisbon':'end', 'Porto':'end','Aveiro':'end', 'Leiria':'end', 'Évora':'start','Faro':'start','Weinfelden':'start','Geneva':'end','Lausanne':'end',
...
'Thun':'top','Kerzers':'top','Ulaanbaatar':'start','Beijing':'end',"Malang":"top", "Tai'an":'end','Nanchang':'end','Shanghai':'start','Taipei':'start','Osaka':'end',"Jinzhou":'top','Seoul':'top','Hong Kong':'top',"Gomel":'start',"Cēsis":'start',
'Denpasar':'start','Quezon City':'start','Cebu City':'start', 'Bangkok':'end',"Donetsk and Makiivka":'start','Lviv':'end','Chișinău':'end','Kiev':'top','Mykolaiv':'start','Minsk':'top',"Grodno":'end','Kharkiv':'start','Rivne':'end','Dnipro':'end',
...
"Concepción":'end',"Copiapó":'end',"Puerto Montt":'start','Rosario':'top','Salta':'end','Neuquén':'end','Bahía Blanca':'start','Rio Grande':'end','Manizales':'end','Cali':'end','Pasto':'end',"Bucaramanga":'start','Cartagena':'end',"Columbus":'start',
'Copenhagen':'start','Roskilde':'end','Aarhus':'end','Esbjerg':'end','Aalborg':'end','Odense':'top','Kolding':'top','Næstved':'start',"Ringsted":'start',"Slagelse":'top',"Macerata":'start','Pisa':'end','Washington, D.C.':'end',"Florence":"start",
...
'Szerencs':'start','Nagyatád':'end','Helsingborg':'end','Östersund':'end','Nagykanizsa':'end','Zalaegerszeg':'end','Szombathely':'end','Veszprém':'start','Szeged':'start','Debrecen':'start','Miskolc':'end','Perzów':'start','Łódź':'top','Zielona Góra':'top','Olsztyn':'start','Dukla':'start',
'Hanover':'top', 'Frankfurt':'end'};
 ...
 'Cheyenne':15,'Laramie':15, 'Toronto':28,'Asunción':16,"San Diego":27, "Sacramento":22, "Tampa":22, "Miami":22, 'Fort Lauderdale': 22,'Warsaw':30, "Katowice": 24,'Kuopio':24,'Hanover':25,'Stuttgart':23,"Schweinfurt":23,"Enschede":22,
 'Bogota': 27, 'Santiago': 30, "Newcastle upon Tyne":25, "London": 23, "Bristol": 20, "Birmingham":21, "Leeds": 21, "Brighton":17, "Glasgow":22, "Edinburgh":22, "Liverpool": 24,"Turku":24,'Jyväskylä':23,"Richmond":22,"Mammoth Lakes":19,
...
'Copenhagen':29,'Roskilde':22,'Aarhus':26,'Esbjerg':23,'Aalborg':22,"Slagelse":18,"Rimini":18,'Pisa':29,"Bologna":23,"Malmö":23,'Växjö':23,"Falkenberg":18,'Manchester':19,"Reading":18,'Nottingham':21,'Calgary':22,'Winnipeg':22,'Pennsylvania':22,
