...
"Lima": "end", "Bogata": "end", "Detroit": "start", "Cleveland":"start",  "Minneapolis":"start","Hamar":"start","Salvador":"start",
...
'Bonn': 'end','Stuttgart': 'end','Leipzig': 'start', 'Münster': 'top',"Buffalo":"end","Rochester":"start","Poznań":'end',"Wollongong":"start","Bolzano":"start","Lecce":'end',
...
'Louisville': 'top','Greensboro': 'end','Lexington': 'start', "Sarasota": "end",  'Katowice':'end',"Tarnów":'start',"Lublin":'start', 'Dalarna': 'top',"Mumbai":"end","Pune":"start",
 ...
 'Flint':'start','Madison':'end','Traverse City':'start','Muncie':'start','Marquette':'top','Eureka':'start','Fort Lauderdale':'top','Turku':'end','Rouen':'end',"Launceston":"top","Córdoba":'top','Kipfenberg':'top',
...
'Bilbao':'end', 'Pamplona':'start','Vigo':'start','Norwich':'start', 'A Coruña':'start','Cardiff':'end','Vitoria-Gasteiz':'end',"Zarautz":'start',"Algeciras":'end', 'Nagoya':'top', 'Tokyo':'start',"Yamaguchi":'top','Istanbul':'top','Augsburg':'end',
...
"Tawau":'end','Sibu':'end','Harare':'top',"Johannesburg":'top',"Durban":'start',"Bloemfontein":'end','Cape Town':'end','Port Elizabeth':'start', 'Tunis':'start', 'Tripoli':'start', 'Algiers':'top','Casablanca':'end', 'Cairo':'start','Nairobi':'start',
'Rawalpindi':'end','Lahore':'end',"Chittagong":'start','Karachi':'end','Guwahati':'start','Kathmandu':'top','Kolkata':'end', 'Dhaka':'top','Maldives':'end','Colombo':'start', 'The Hague':'top', 'Amsterdam':'top', 'Sneek':'top','Groningen':'start',"Winterswijk":'start',
 'Tilburg':'end', 'North Brabant':'start','Heerlen':'start', 'Funchal':'start', 'Lisbon':'end', 'Porto':'end','Aveiro':'end', 'Leiria':'end','Weinfelden':'start','Geneva':'start','Lausanne':'end',
...
'Thun':'top','Kerzers':'top','Ulaanbaatar':'start','Beijing':'end',"Malang":"top", "Tai'an":'end','Nanchang':'end','Shanghai':'start','Taipei':'start',"Jinzhou":'top','Seoul':'top','Hong Kong':'top',"Gomel":'start',"Cēsis":'start',
...
'Hanover':'top', 'Frankfurt':'end','Skien':'end','Helsinki':'start','Rovaniemi':'start','Paris':'start',"León":'end',"Weil am Rhein":'start'};
